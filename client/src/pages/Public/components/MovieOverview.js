      ...
      <Grid item xs={8} container direction="column" spacing={2}>
        ...
        <Grid item xs>
          <Stats
            ...
            stats={[
              [
                { label: 'Дата выхода', value: '15 июня 2025' },
                { label: 'Продолжительность', value: '1h 20mins' },
                { label: 'Режиссёр', value: 'Becomegloomy' },
                { label: 'Жанр', value: 'Боевик' },
                { label: 'Статус', value: 'Выпущен' },
                { label: 'Язык', value: 'Английский' }
              ]
            ]}
          />
        </Grid>
